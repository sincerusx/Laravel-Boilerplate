...
namespace PHPSTORM_META {
	 ...
	 */
	override( new \Illuminate\Contracts\Container\Container,
			  map( [
					   ''                                                    => '@',
	...
	override( \Illuminate\Contracts\Container\Container::make( 0 ),
			  map( [
					   ''                                                    => '@',
					   'events'                                              => Illuminate\Events\Dispatcher::class,
					   'log'                                                 => Illuminate\Log\Writer::class,
	...
	override( \Illuminate\Contracts\Container\Container::makeWith( 0 ),
			  map( [
					   ''                                                    => '@',
					   'events'                                              => Illuminate\Events\Dispatcher::class,
					   'log'                                                 => Illuminate\Log\Writer::class,
